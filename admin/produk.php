...
<body>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header" style="background-color: #957DAD">
    <h1 class= "text-center text-white">Product Data</h1>
        <form action="produk.php" method="POST" class="d-flex">
        <input class="form-control me-2" type="search" name="cari" placeholder="Search" aria-label="Search">
            <button class="btn text-white" style="background-color: #E0BBE4" type="submit">Search</button>
        </form>
        </div>
    <div class="card-body">
        <table class="table table-striped text-white" style="background-color: #957DAD">
    <thead>
        <tr>
...
<td><a href="tambah_produk.php" class="btn text-white" style="background-color: #957DAD">Tambah Produk</a></td>
    </div>
        </div>
    </div>

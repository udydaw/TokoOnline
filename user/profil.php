...
<body>
    <?php
        ...
        <div class="col">
                ...
                <table class="table table-hover table-striped mb-4 text-white" style="background-color: #E0BBE4">
        ...
        <a href="home.php" class="btn text-white" style="background-color: #957DAD">Kembali ke halaman utama</a>
        <div style="float: right;">
        <a
            href="ubah_pelanggan.php?id_pelanggan=<?=$data_pelanggan['id_pelanggan']?>"
            class="btn text-white" style="background-color: #957DAD">Ubah Akun Ini</a> | <a
            href="hapus_pelanggan.php?id_pelanggan=<?=$data_pelanggan['id_pelanggan']?>"
            onclick="return confirm('Apakah anda yakin menghapus data ini?')" 
            class="btn text-white" style="background-color: #957DAD">Hapus Akun Ini</a>
    </div>
        </section>        
        </main>   
    <?php
